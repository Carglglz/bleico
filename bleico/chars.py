...
from bleak.utils import CHARS_UNITS, DATA_FMT
            ...
            try:
                ...
                if val.tag == 'Unit':
                    ...
                    try:
                        ...
                        self.unit_symbol = CHARS_UNITS[self.unit]
            ...
            try:
                ...
                if val.tag == 'Unit':
                    ...
                    try:
                        ...
                        self.fields[self.actual_field]['Symbol'] = CHARS_UNITS[unit]
                    except Exception as e:
                        # print(traceback.format_exc())
                        try:
                            self.fields[self.actual_field][val.tag] = quantity
                            self.fields[self.actual_field]['Symbol'] = CHARS_UNITS[quantity]
                        except Exception as e:
                            self.fields[self.actual_field][val.tag] = ''
